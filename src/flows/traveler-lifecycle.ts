...
export const travelerLifecycle: FlowDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      route: '/my-trips',
      label: 'Choose Membership Tier',
      component: 'MembershipPlans',
      tab: 'account',
      roles: ['renter'],
      description: 'Traveler selects Free, Plus ($5/mo), or Premium ($15/mo) membership tier.',
      tables: ['membership_tiers', 'user_memberships'],
      edgeFunctions: ['create-subscription-checkout'],
      branches: [
        { condition: 'Free tier', targetStepId: 'search_listings', label: 'Stay free' },
        { condition: 'Paid tier selected', targetStepId: 'subscription_checkout', label: 'Subscribe' },
      ],
    },
    {
      ...
      roles: ['renter'],
      description: 'Stripe Checkout handles payment for monthly subscription. Webhook updates membership on success.',
      tables: ['user_memberships'],
      edgeFunctions: ['create-subscription-checkout', 'stripe-webhook'],
      branches: [
        { condition: 'Payment successful', targetStepId: 'search_listings', label: 'Continue browsing' },
      ],
    },
    {
      id: 'report_issue',
