...
| **E** — Per-category dispute role enforcement in schema/RLS | [#463](https://github.com/rent-a-vacation/rav-website/issues/463) | 🔧 Queued | Session 63 PR | Brings RLS parity with `AdminDisputes.tsx` UI gating |
...
| **G** — SLA enforcement + alerting + business-hours config | [#464](https://github.com/rent-a-vacation/rav-website/issues/464) | 🔧 Queued | Session 63 PR | Once advertised, SLAs are marketplace promises |
| **H** — Auto-mirror Stripe `charge.dispute.created` to internal disputes | [#465](https://github.com/rent-a-vacation/rav-website/issues/465) | 🔧 Queued | Session 63 PR | Chargeback evidence windows are tight — manual mirroring loses time |
