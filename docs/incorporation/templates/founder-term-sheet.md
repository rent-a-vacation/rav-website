...
# Founder Term Sheet — Rent-A-Vacation, Inc. (Delaware C-Corp)

> **TEMPLATE.** Copy this file, fill in `[BRACKETED CAPS]` placeholders, resolve `<!-- TODO -->` comments, then collect all four founder signatures BEFORE starting the Stripe Atlas filing process.

> **Why this exists:** Per Yokum Taku's Round 1 boardroom position — Atlas issues founder shares at filing and you cannot easily redo this. Lock the equity split first.

> **Legal status:** This is an **internal pre-incorporation agreement** between the four founders. It is binding among the founders but is NOT a substitute for the formal Stock Purchase Agreements that Atlas will generate. Those formal agreements supersede this term sheet at incorporation. Keep this term sheet on file to document the pre-incorporation intent.

---

## 1. The Parties

The undersigned four individuals (together, the **"Founders"**) are forming **Rent-A-Vacation, Inc.** (the **"Company"**), a Delaware corporation that will operate the Rent-A-Vacation marketplace platform.
...
All founder Common Stock vests on the following schedule (Atlas default — do not change):

- **Vesting period:** 4 years
- **Cliff:** 1 year (no shares vest until 12 months after the vesting commencement date)
...
Each Founder agrees to file a Section 83(b) election with the Internal Revenue Service **within 30 calendar days** of receiving their founder stock. This is a hard IRS deadline that cannot be extended.

The 83(b) election causes the Founder to be taxed on the value of the stock at issuance (which should be near-zero given the company's pre-formation state) rather than on the appreciation as the stock vests. Without a timely 83(b) election, the Founder will pay ordinary income tax on the value of each portion of stock as it vests over four years.

**Atlas will provide:** The 83(b) election form, instructions for filling it in, and the IRS mailing address.

**Each Founder is individually responsible for:** Mailing the 83(b) election (certified mail, return receipt requested), retaining a copy with proof of mailing, and providing a copy to the Company for the corporate records.
...
- The cleared Founder signs their Stock Purchase Agreement with vesting commencement dated as of the actual signing date (NOT back-dated to the original incorporation date — this preserves the integrity of the 83(b) election window).
- The cleared Founder files their 83(b) election within 30 days of signing.
- The cleared Founder formally takes their officer role via a board consent.

**If OBA disclosures do not clear within 12 months of incorporation:** The reserved allocations revert to the option pool unless all four founders agree in writing to extend the reservation. <!-- TODO: confirm 12-month timeframe with all four founders. Could be shorter (6 months) or longer (18 months) depending on each employer's typical OBA review timeline. -->
...
By signing below, each Founder agrees to the terms above and commits to taking the actions required (executing Stock Purchase Agreements, filing 83(b) elections, signing the CIIAA, etc.) as outlined.

| Founder | Signature | Date |
|---------|-----------|------|
| [SUJIT FULL LEGAL NAME] | _______________________ | __________ |
| [AJUMON FULL LEGAL NAME] | _______________________ | __________ |
| [SANDHYA FULL LEGAL NAME] | _______________________ | __________ |
| [CELIN FULL LEGAL NAME] | _______________________ | __________ |
...
## Appendix A — Things explicitly NOT decided in this term sheet

- **Salary or cash compensation** for any Founder. Likely none until first financing; addressed separately.
- **Voting agreements** beyond the standard one-share-one-vote on Common Stock. Add later if needed.
- **Right of first refusal / co-sale rights** between Founders. Atlas's Stock Purchase Agreements include standard transfer restrictions; additional ROFR/co-sale can be added at first financing.
- **Anti-dilution protections** for Founders. Generally not granted at formation; addressed at first financing.
- **Acceleration on change of control** (single-trigger or double-trigger). Not granted at formation; standard practice to add at first financing.

These are intentionally deferred — they're typically negotiated at the time of the first outside investment, when an investor's attorney drafts the financing documents.
