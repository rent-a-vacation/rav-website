...
**Business name:** Rent-A-Vacation

**Category (primary):** Vacation rental agency

**Category (secondary):** Travel agency

**Service area:** United States (nationwide, online business)
...
1. RAV logo (profile photo)
2. Homepage screenshot (showing search + featured resorts)
3. 3-5 resort photos (best properties from each brand)
4. SmartEarn calculator screenshot
5. Mobile view screenshot (shows responsiveness)
...
**Button:** Learn More -> https://rent-a-vacation.com
```
...
Every owner verified. Every payment protected. Visit rent-a-vacation.com to explore.
```

### Post 2: SmartEarn Calculator
**Button:** Learn More -> https://rent-a-vacation.com/calculator
```
Are your timeshare maintenance fees going to waste?

Our free RAV SmartEarn Calculator shows exactly how many weeks you need to rent to cover your annual fees — and how much you could earn beyond that. Works with all 9 major vacation club brands.

No account needed. Try it now at rent-a-vacation.com/calculator
```

### Post 3: How It Works
**Button:** Sign Up -> https://rent-a-vacation.com/signup
```
How Rent-A-Vacation works:

FOR TRAVELERS:
1. Search by voice, text, or filters
2. Find your perfect resort
3. Book directly or Name Your Price
4. Payment protected until check-in

FOR OWNERS:
1. List your unused week (takes 5 minutes)
2. Get AI-powered pricing suggestions
3. Approve or counter offers
4. Get paid via Stripe

Simple. Safe. Smart. Start at rent-a-vacation.com
```

## JSON-LD Update Needed (Code Task)
After creating the profile, update the Organization JSON-LD in the website to include `sameAs` with the Google Business Profile URL. This connects the website to the profile for SEO.
